...
import { ContentModal, LinkMore, ModalButton } from './styles';
...
export default function SendMessage({
  ...
  function handleSelectContacts() {
    ...
    dataContacts.map((item) => {
      if (item.tableData.checked === true) qtd++;
    });
    setContacts(qtd);
  ...
  function handleSelectGroups() {
    ...
    dataGroups.map((item) => {
      if (item.tableData.checked === true) qtd++;
      if (item.tableData.checked === true) qtd2 += item.membros;
    });
    setContacts(qtd2);
    setGroups(qtd);
    setOpenGroup(false);
    ...
    <>
      ...
      >
        <ContentModal>
          ...
          />
          <ModalButton>
            <button type="button" onClick={handleSelectContacts}>
      ...
      <Modal open={openGroup} onClose={() => setOpenGroup(false)}>
        <ContentModal>
          <MaterialTable
          ...
          />
          <ModalButton>
            <button type="button" onClick={handleSelectGroups}>
              <MdCheck size={20} color="#fff" />
              Selecionar
            </button>
          </ModalButton>
